...
class MassCancel extends PackNotificationAction
{
    /**
        ...
        if ($this->isValid()) {
            ...
            if ($itemsSent) {
                $this->messageManager->addSuccessMessage(
                    __('A total of %1 pack notification(s) have been canceled.', $itemsSent)
                );
            }
            ...
            if ($itemsSentError) {
                $this->messageManager->addErrorMessage(
                    __(
                        'A total of %1 pack notification(s) haven\'t been canceled. Please see server logs for more details.',
                        $itemsSentError
                    )
                );
            }
