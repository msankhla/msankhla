 ...
 */
class OptionShippingManagement implements
    \ShipperHQ\Option\Api\OptionShippingManagementInterface
{
    /**
     ...
     *
     * @param OptionShippingProcessor $optionShippingProcessor
     */
    ...
    public function requestRates(
        ...
        return $this->optionShippingProcessor
            ->requestShippingRates($cartId, $optionShippingInformation);
    }
}
