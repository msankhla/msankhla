 ...
 */
class DateShippingManagement implements
    \ShipperHQ\Calendar\Api\DateShippingManagementInterface
{
    /**
     ...
     *
     * @param DateShippingProcessor $dateShippingProcessor
     */
    public function __construct(
        DateShippingProcessor $dateShippingProcessor
    ) {
    ...
    {
        return $this->dateShippingProcessor
            ->requestShippingRates($cartId, $dateShippingInformation);
    }
}
